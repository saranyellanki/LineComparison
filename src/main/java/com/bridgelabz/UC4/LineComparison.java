...
public class LineComparison {
    ...
    public LineComparison calculateLengthOfLine() {
    ...
    public static int compareLines(LineComparison result1, LineComparison result2) {
        return compare(result1.lengthOfLine, result2.lengthOfLine);
    }
    public static void lineCoOrdinates(){
        ...
        int y2 = sc.nextInt();
        LineComparison result1 = new LineComparison(x1, x2, y1, y2);
        ...
        int y4 = sc.nextInt();
        LineComparison result2 = new LineComparison(x3, x4, y3, y4);
        result2.calculateLengthOfLine().show();

        finalResult = compareLines(result1, result2);
        if (finalResult == 0)
